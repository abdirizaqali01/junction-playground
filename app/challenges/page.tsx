...
export default function ChallengesPage() {
  ...
  const handleSideChallengeClick = (challengeId: number) => {
    router.push('/challenges/side')
  }

  const handleMainChallengeClick = (challengeId: number) => {
    router.push('/challenges/main')
  }
                    ...
                    <div className="space-y-3 mr-16">
                      {trackChallenges.map((challenge) => (
                        <div 
                          ...
                          onClick={() => handleMainChallengeClick(challenge.id)}
                        >
                          <div className="p-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                {displayedChallenges.map((challenge) => (
                  <div 
                    ...
                    onClick={() => handleSideChallengeClick(challenge.id)}
                  >
                    {/* Challenge Header */}
                    <div className="p-4">
