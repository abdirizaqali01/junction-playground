    ...
    <>
      ...
      <div className="text-center py-32">
        <h1 className="text-5xl font-bold mb-6">
          ...
          <span className="text-[var(--color-light-opacity100)]">Name</span>
        </h1>
        <p className="text-[var(--color-light-opacity60)] text-lg">
      ...
      <div className="pb-24">
        <h2 className="text-[var(--color-light-opacity100)] text-lg font-medium mb-6 text-left">Most frequented</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-2 max-w-lg">
          {/* Community Card */}
          <div className="bg-zinc-900 border border-[var(--color-primary-opacity100)] rounded p-2 hover:border-[var(--color-primary-opacity60)] transition-colors aspect-square flex flex-col items-center justify-center">
            <div className="mb-1">
              <div className="grid grid-cols-3 gap-0.5">
                <div className="w-1 h-1 bg-[var(--color-primary-opacity100)] rounded-[1px]"></div>
                <div className="w-1 h-1 bg-[var(--color-primary-opacity100)] rounded-[1px]"></div>
                <div className="w-1 h-1 bg-[var(--color-primary-opacity100)] rounded-[1px]"></div>
                <div className="w-1 h-1 bg-[var(--color-primary-opacity100)] rounded-[1px]"></div>
                <div className="w-1 h-1 bg-[var(--color-primary-opacity100)] rounded-[1px]"></div>
            ...
            <h3 className="text-[var(--color-light-opacity100)] text-xs font-medium">Community</h3>
          </div>
          ...
          <div className="bg-zinc-900 border border-[var(--color-primary-opacity100)] rounded p-2 hover:border-[var(--color-primary-opacity60)] transition-colors aspect-square flex flex-col items-center justify-center">
            ...
            <h3 className="text-[var(--color-light-opacity100)] text-xs font-medium">Challenges</h3>
          </div>

          {/* Event Name Card */}
          <div className="bg-zinc-600 border border-[var(--color-primary-opacity100)] rounded p-2 hover:border-[var(--color-primary-opacity60)] transition-colors aspect-square flex flex-col items-center justify-center">
            <h3 className="text-[var(--color-light-opacity100)] text-xs font-medium">Event Name</h3>
          </div>
        </div>
      </div>
      ...
      <div className="mb-16">
        <h2 className="text-[var(--color-light-opacity100)] text-xl font-medium mb-6">Upcoming event</h2>
        <div className="bg-zinc-800 rounded-2xl p-8">
          <h3 className="text-3xl font-bold text-[var(--color-light-opacity100)] mb-6">Event Name</h3>
          <p className="text-[var(--color-light-opacity60)]">Event details will be displayed here...</p>
        </div>
      </div>
    </>
  )
